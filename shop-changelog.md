...
1. В случае наличия Onliner ID в предложении, товар будет сопоставлен с товаром в каталоге по Onliner ID. Для успешного обновления данных достаточно только одного Onliner ID — поля Раздел, Производитель, Товар, Артикул не обязательны.
...
* Колонка `Промоцена` (**csv**) в прайс-листах переименована в `Цена по промокоду`
